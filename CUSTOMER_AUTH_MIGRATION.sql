-- =============================================================================
-- PLANT PROTEIN STORE - CUSTOMER AUTHENTICATION SYSTEM MIGRATION
-- =============================================================================
--
-- PURPOSE: This migration adds customer authentication functionality including:
...
--
-- WHAT THIS CREATES:
--   - Adds columns to customers table: password_hash, email_verified, last_login
--   - Creates unique index on customers.email
--   - Creates wishlist table
--   - Creates customer_addresses table
--   - Creates customer_sessions table
--   - Adds performance indexes
--   - Sets up Row Level Security (RLS) policies
--   - Creates triggers for auto-updating timestamps
--   - Creates customer_order_history view
--
-- SAFE TO RE-RUN: Yes, uses IF NOT EXISTS and IF EXISTS checks
--
-- =============================================================================

-- 1. Add authentication fields to customers table
-- Note: Only adds new columns (password_hash, email_verified, last_login)
-- The created_at and updated_at columns already exist in the customers table
