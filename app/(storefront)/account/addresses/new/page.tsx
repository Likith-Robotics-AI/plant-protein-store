...
import { MapPin, ArrowLeft, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function NewAddressPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFieldErrors({ full_name: 'An error occurred while creating the address' });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black text-gray-900">Add New Address</h1>
